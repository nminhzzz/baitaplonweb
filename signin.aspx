<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signin.aspx.cs" Inherits="baitaplon.WebForm4" %>
        ...
        <div class="signin">
            <div class="signin__container">
                ...
                <div class="signin__form" action="#">
                    <label for="phone">
                        phone:<br />
                        <input class="signin__input1"
                            type="tel" id="phone" placeholder="Nhập số điện thoại" />
                    </label>
